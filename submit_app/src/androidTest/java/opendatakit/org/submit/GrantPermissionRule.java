...
public class GrantPermissionRule implements TestRule {
    ...
    private void grantPermissions(String...  permissions) {
        mPermissionRequester.addPermissions(permissions);
    }

    @Override
    public final Statement apply(final Statement base, Description description) {
        return new GrantPermissionRule.RequestPermissionStatement(base);
    }

    @VisibleForTesting
    protected void setPermissionRequester(PermissionRequester permissionRequester) {
        mPermissionRequester = checkNotNull(permissionRequester,
                "permissionRequester cannot be null!");
    }
