 ...
 * Original file: /Users/mvigil/ODK/opendatakit.submit/src/org/opendatakit/submit/client/ClientRemote.aidl
 */
package org.opendatakit.submit.client;
public interface ClientRemote extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements org.opendatakit.submit.client.ClientRemote
{
private static final java.lang.String DESCRIPTOR = "org.opendatakit.submit.client.ClientRemote";
...
/**
 * Cast an IBinder object into an org.opendatakit.submit.client.ClientRemote interface,
 * generating a proxy if needed.
 */
public static org.opendatakit.submit.client.ClientRemote asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof org.opendatakit.submit.client.ClientRemote))) {
return ((org.opendatakit.submit.client.ClientRemote)iin);
}
return new org.opendatakit.submit.client.ClientRemote.Stub.Proxy(obj);
}
...
java.lang.String _result = this.send(_arg0, _arg1);
...
java.lang.String _result = this.create(_arg0, _arg1, _arg2);
reply.writeNoException();
reply.writeString(_result);
if ((_arg0!=null)) {
reply.writeInt(1);
...
java.lang.String _arg2;
_arg2 = data.readString();
java.lang.String _result = this.download(_arg0, _arg1, _arg2);
reply.writeNoException();
reply.writeString(_result);
if ((_arg0!=null)) {
reply.writeInt(1);
...
java.lang.String _arg2;
_arg2 = data.readString();
java.lang.String _result = this.delete(_arg0, _arg1, _arg2);
reply.writeNoException();
reply.writeString(_result);
if ((_arg0!=null)) {
reply.writeInt(1);
...
private static class Proxy implements org.opendatakit.submit.client.ClientRemote
{
...
@Override public java.lang.String send(java.lang.String uri, java.lang.String pathname) throws android.os.RemoteException
{
...
@Override public java.lang.String create(org.opendatakit.submit.flags.SyncType st, java.lang.String uri, java.lang.String pathname) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
@Override public java.lang.String download(org.opendatakit.submit.flags.SyncType st, java.lang.String uri, java.lang.String pathname) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
@Override public java.lang.String sync(org.opendatakit.submit.flags.SyncType st, java.lang.String uri, java.lang.String pathname) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
@Override public java.lang.String delete(org.opendatakit.submit.flags.SyncType st, java.lang.String uri, java.lang.String pathname) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
